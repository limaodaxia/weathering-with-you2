...
class WeatherFragmentViewPager2Adapter(var placeList: List<Place>, activity: WeatherActivity)
    ...
    override fun createFragment(position: Int): WeatherFragment {
        return WeatherFragment(placeList[position])
    }

    override fun getItemId(position: Int): Long {
        val id = placeList[position].hashCode().toLong()
        idSet.add(id)
